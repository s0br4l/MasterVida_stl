...
st.set_page_config(page_title="Programa Master Vida", page_icon='images/logomaster_icon.ico', layout="centered", initial_sidebar_state="auto", menu_items=None)

container1 = st.container()
container1.image(Image.open('images/large_master_image.png'))

container2 = st.container()
container2.text_area('info', "🗒️ Checklist Master Vida  \n\n"
