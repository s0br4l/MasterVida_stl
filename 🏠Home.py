...
st.set_page_config(page_title="Programa Master Vida", page_icon=None, layout="centered", initial_sidebar_state="collapsed", menu_items=None)
...
container2.text_area('', "🗒️ Checklist Master Vida  \n\n"
                                              ...
                                              "‼️ Organizar o quanto antes os materiais da aula.\n\n"
